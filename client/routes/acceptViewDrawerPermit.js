...
import AcceptDetailPage from '../screens/acceptDetailPage';
...
export default function AccpetViewPermitDrawer() {
  return (
      <Drawer.Navigator
       initialRouteName="Page fifteen"
       screenOptions={{
        headerStyle: {
      ...
      >
        ...
        <Drawer.Screen name="Page fifteen" component={AcceptDetailPage} />
      </Drawer.Navigator>
  );
}
