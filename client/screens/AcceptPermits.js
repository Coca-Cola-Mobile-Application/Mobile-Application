...
export default function AcceptPermits({ navigation ,route}) {
            ...
            <View style={globalStyles.insideContainer}>
                <ScrollView>
                    <View style={globalStyles.bodyView}>
                        <CenterTopicOnly topicDetail={topicDetails[15]}/>
                        <Card> 
                            <FlatList
                                data={fillList}
                                renderItem={({ item }) => (
                                    <AllPermitsCard topicDetail={item} navigateName="AcceptPermitPageDrawer" />
                                )}
