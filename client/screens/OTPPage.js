  ...
  return (
    <View style={styles.content}>
      ...
      <View style={styles.header_container}>
        <Text style={styles.header_text}>Welcome to the OTPPage</Text> 
        <Text style={styles.header_subText}>Check Your Email</Text> 
      </View>

      <View style={styles.logo_container}>
        <Image source={require('../assets/locked_1.png')} style={styles.logo} />
      </View>
      ...
      <View style={styles.form_container}>
       ...
       <Title level={6}></Title>
       <Input.OTP formatter={(str) => str.toUpperCase()} {...sharedProps} style={styles.otp_button} />
       </Flex>
